...
class EmergencyPhoneNumbersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val names = arrayOf("Single Emergency Call Number", "Emergency SMS (only for registered people)", "Child's phone",
            "Consumers Protection", "Border Police", "Romanian Automotive Register (RAR) - Appointments and Informations",
            "Ministry of Public Finance - Consumers phone", "Green line anti-corruption",
            "National Sanitary Veterinary and Food Safety Authority", "National Tourism Authority - Consumers phone",
        ...
        val phoneNumbers = arrayOf("112", "113", "119", "+40219551", "+40219590", "+40219672", "+40800800085",
